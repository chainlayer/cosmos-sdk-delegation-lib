...
TerraDelegateTool.prototype.retrieveBalances = function _callee10(addressList) {
  var _this5 = this;
...
TerraDelegateTool.prototype.getRewards = function _callee11(validator, addr) {
  var _this6 = this;
...
TerraDelegateTool.prototype.txCreateDelegate = function _callee12(txContext, validatorBech32, uatomAmount, memo) {
  var accountInfo;
    ...
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 6:
          ...
          return _context12.abrupt("return", _terra["default"].createDelegate(txContext, validatorBech32, (0, _big["default"])(uatomAmount), memo));
...
TerraDelegateTool.prototype.txCreateRedelegate = function _callee13(txContext, validatorSourceBech32, validatorDestBech32, uatomAmount, memo) {
  var accountInfo;
    ...
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 6:
          ...
          return _context13.abrupt("return", _terra["default"].createRedelegate(txContext, validatorSourceBech32, validatorDestBech32, uatomAmount, memo));
...
TerraDelegateTool.prototype.txCreateUndelegate = function _callee14(txContext, validatorBech32, uatomAmount, memo) {
  var accountInfo;
    ...
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 6:
          ...
          txContext.sequence = accountInfo.sequence;
          return _context14.abrupt("return", _terra["default"].createUndelegate(txContext, validatorBech32, uatomAmount, memo));
...
TerraDelegateTool.prototype.txCreateWithdrawl = function _callee15(txContext, validatorBech32, memo) {
  var accountInfo;
    ...
    while (1) {
      switch (_context15.prev = _context15.next) {
        ...
        case 6:
          ...
          txContext.sequence = accountInfo.sequence;
          return _context15.abrupt("return", _terra["default"].createWithdrawl(txContext, validatorBech32, memo));
...
TerraDelegateTool.prototype.txSubmit = function _callee16(signedTx) {
  var _this7 = this;
...
TerraDelegateTool.prototype.txStatus = function _callee17(txHash) {
  var _this8 = this;
