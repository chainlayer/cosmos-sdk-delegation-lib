  ...
  return _regenerator["default"].async(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          url = "https://min-api.cryptocompare.com/data/price?fsym=ATOM&tsyms=USD";
...
CosmosDelegateTool.prototype.getRewards = function _callee9(addr) {
  var _this5 = this;
      ...
      switch (_context9.prev = _context9.next) {
        case 0:
          ...
          return _context9.abrupt("return", _axios["default"].get(url).then(function (r) {
            ...
            try {
              if (typeof r.data.result.rewards[0].reward[0].amount !== 'undefined' && r.data.result.rewards !== null) {
                reward = r.data.result.rewards[0].reward[0].amount;
              }
            } catch (e) {
              console.log('Error ', e, ' returning defaults');
            }
...
CosmosDelegateTool.prototype.txCreateDelegate = function _callee10(txContext, validatorBech32, uatomAmount, memo) {
  var accountInfo;
    ...
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 6:
          ...
          return _context10.abrupt("return", _cosmos["default"].createDelegate(txContext, validatorBech32, (0, _big["default"])(uatomAmount), memo));
...
CosmosDelegateTool.prototype.txCreateRedelegate = function _callee11(txContext, validatorSourceBech32, validatorDestBech32, uatomAmount, memo) {
  var accountInfo;
...
CosmosDelegateTool.prototype.txCreateUndelegate = function _callee12(txContext, validatorBech32, uatomAmount, memo) {
  var accountInfo;
...
CosmosDelegateTool.prototype.txCreateWithdrawl = function _callee13(txContext, validatorBech32, memo) {
  var accountInfo;
    ...
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 6:
          ...
          txContext.sequence = accountInfo.sequence;
          return _context13.abrupt("return", _cosmos["default"].createWithdrawl(txContext, validatorBech32, memo));
...
CosmosDelegateTool.prototype.txSubmit = function _callee14(signedTx) {
  var _this6 = this;
...
CosmosDelegateTool.prototype.txStatus = function _callee15(txHash) {
  var _this7 = this;
